...
public @interface ShardAware {
  ...
  /**
   * <code>true</code> if the transaction is read-only. Defaults to
   * <code>false</code>.
   * <p>
   ...
   * "java.lang.Exception" would be correct if "Exception" was meant to define a
   * rule for all checked exceptions. With more unusual {@link Exception} names
