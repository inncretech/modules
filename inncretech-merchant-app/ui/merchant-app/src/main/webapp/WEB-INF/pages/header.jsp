...
<link rel="stylesheet" type="text/css"
	...
	media="screen" />
<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/bootstrap-combobox.css"/>"
	media="screen" />

<link rel="stylesheet" type="text/css"
	href="<c:url value="/resources/css/bootstrap-select.css"/>"
	media="screen" />
<link href="<c:url value="/resources/css/new_styling.css"/>"
...
<script type="text/javascript"
	src="<c:url value="/resources/js/dynamic_list_helper.js"/>"></script>
<meta name="viewport"
...
<script type="text/javascript"
	src="<c:url value="/resources/js/bootstrap_datatable.js"/>"></script>
