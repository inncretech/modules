...
!function( $ ) {
 ...
 "use strict";
  ...
  , lookup: function (event) {
	  if(this.$element.val().length<2 && this.$element.val()!=''){
		  return;
	  }
  ...
  template: '<div class="combobox-container"><input type="hidden" /><input type="text" autocomplete="off" /><span class="add-on btn dropdown-toggle" style="display:block !important;" data-dropdown="dropdown"><span class="caret"/><span class="combobox-clear"><i class="icon-remove"/></span></span></div>'
