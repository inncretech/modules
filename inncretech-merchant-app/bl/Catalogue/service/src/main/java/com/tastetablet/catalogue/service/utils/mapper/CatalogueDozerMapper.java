package com.tastetablet.catalogue.service.utils.mapper;
...
public class CatalogueDozerMapper {
	...
	void mapproductDTOToProduct(Product product, ProductDTO productDTO) {
		if (product != null) {
			...
			productDTO.setStatus(com.tastetablet.catalogue.constants.Status.valueOf(product.getStatus().toString()));
